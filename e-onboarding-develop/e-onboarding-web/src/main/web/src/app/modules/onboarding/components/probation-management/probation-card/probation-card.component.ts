...
@Component({
  selector: 'app-probation-card',
  templateUrl: './probation-card.component.html',
  styleUrls: ['./probation-card.component.scss']
})
export class ProbationCardComponent implements OnInit {
